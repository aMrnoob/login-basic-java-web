	...
	<form method="POST">
		<div class="container">
			...
			<div class="account">
				...
				<input type="text" style="margin-left: 10px;" name="pw" placeholder="Nhập mật khẩu" class="pw-field" required /> 
			</div>	
			<div class="account">
				<label class="pw" style="margin-left: 100px;"> Xác nhận mật khẩu: </label> 
				<input type="text" style="margin-left: 10px;" name="pw" placeholder="Xác nhật mật khẩu" class="pw-field" required /> 
			</div>	
